(function (app) {
    app.controller('medicineEditController', medicineEditController);

    medicineEditController.$inject = ['apiService', '$scope', 'notificationService', '$state', '$stateParams'];

    function medicineEditController(apiService, $scope, notificationService, $state, $stateParams) {
        $scope.medicine = {
